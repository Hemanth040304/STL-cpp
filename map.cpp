...
it returns pair of key and value to us.

size(): The run time of this method is O(1)

[] bracket operators: The run time of this method is O(log n),
if the key exists, then it returns reference to the value.
